...
| **IP de Gestión** | 10.77.1.2 |
| **Puerto SSH** | 56661 |
| **Puerto gNMI** | 56662 → 57400 |
| **Puerto NETCONF** | 56663 → 830 |
...
Habilitación de gNMI para telemetría y automatización:
...
!!! info "gNMI Telemetry"
    ...
    El puerto gNMI (57400) permite la suscripción a métricas en tiempo real usando el collector gNMIC.
...
|------|------|-----|---------|
| 1 | IOM5-e | me6-100gb-qsfp28 | Puertos 100G hacia TX |
...
/configure router "Base" router-id 10.77.1.2
...
```
### 16.3.1 VPRN 9999 INTERFACE TO-IPERF
...
### 16.4 VPRN 9998 (NAT INSIDE - Suscriptores)
...
# Capture-SAP para todos los paquetes QinQ
